...
const SalesDeskVisitFormReportPage = lazyImport(() => import('@/features/salesdesk'), 'SalesDeskVisitFormReportPage');
  ...
  return createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: 'salesdesk/visit-form-report', element: <SalesDeskVisitFormReportPage /> },
