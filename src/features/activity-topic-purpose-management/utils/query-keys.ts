export const ACTIVITY_TYPE_QUERY_KEYS = {
  LIST: 'activityTopicPurposeManagement.activityType.list',
  DETAIL: 'activityTopicPurposeManagement.activityType.detail',
  STATS: 'activityTopicPurposeManagement.activityType.stats',
} as const;
