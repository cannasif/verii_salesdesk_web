                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1 text-xs leading-relaxed text-zinc-600 dark:text-zinc-300">
                        Kur değerini düzenleyip <span className="font-semibold">Kaydet ve Uygula</span> dediğinizde satır fiyatları, KDV ve sipariş toplamı yeni kura göre güncellenecektir.
                      </div>
                    </div>
                  </div>
