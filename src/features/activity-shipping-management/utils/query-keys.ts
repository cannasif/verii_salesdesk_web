export const ACTIVITY_TYPE_QUERY_KEYS = {
  LIST: 'activityShippingManagement.activityType.list',
  DETAIL: 'activityShippingManagement.activityType.detail',
  STATS: 'activityShippingManagement.activityType.stats',
} as const;
